...
（特徴１）
１つのソフトでスタックチャンのボディ作成前と作成後の全てができます。
サーボ調整の機能を一体化させたことにより、スタックチャンのボディ作成前は、「顔だけ」で使用しながら、そのまま、サーボの動作チェック、「センター出し」、ボディ作成後（サーボ固定後）は、調整の反映など、一連の作業を１つのソフトで賄います。
...
起動後に、PC等のWEBから、IPアドレスを入力すると「Welcome To AiStackChanEx」画面が起動します。  
メニューの「８．サーボ調整」に移動してください。あとは、画面の指示に従って調整を進めてください。
